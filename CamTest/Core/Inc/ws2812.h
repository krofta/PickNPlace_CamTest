...
//--------------------------------------------------
/*USR SETTINGS*/
#define LED_COUNT 28						// Count of led in your strip (LED_COUNT%12 = 0)
#define BRIGHT 10 							// 0-255
#define TIM_HANDLE	htim3					// use "htimX", where X is number of ur timer
#define TIM_CH	TIM_CHANNEL_1				// use "TIM_CHANNEL_X", where X is number of ur channel
//--------------------------------------------------
/*SYS DEFINES*/
...
#define PWM_PERIOD 1.15						// PWM Frequenz in us
