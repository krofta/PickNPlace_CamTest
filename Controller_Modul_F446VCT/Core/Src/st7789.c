...
void ST7789_Test(void)
{
	...
	ST7789_WriteString(10, 10, "Font test.", Font_11x18, GBLUE, WHITE);
	ST7789_WriteString(10, 50, "Hello du!", Font_11x18, RED, WHITE);
	ST7789_WriteString(10, 75, "Hello ich!", Font_11x18, YELLOW, WHITE);
	ST7789_WriteString(10, 100, "Hello du!", Font_11x18, MAGENTA, WHITE);
	HAL_Delay(1000);
